            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {!! Form::text('prefix', null, ['id'=>'prefix','class' => 'form-control','maxlength'=>'6','onkeypress'=>'return (event.charCode === 8 || (event.charCode >= 65 && event.charCode <= 90)||(event.charCode >= 95 && event.charCode <= 122))||(event.charCode === 0 || (event.charCode >= 48 && event.charCode <= 57))']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
                        {!! Form::label('user_id', 'Users') !!}<span class="required">*</span>
                        {!! Form::select('user_ids[]', $users, null, ['id' => 'user_ids','class' => 'form-control', 'multiple']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
                        {!! Form::label('client', 'Client') !!}<span class="required">*</span>
                        {!! Form::select('client_id', $clients, null, ['id'=>'client_id','class' => 'form-control', 'placeholder' => 'Select Client']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12">
